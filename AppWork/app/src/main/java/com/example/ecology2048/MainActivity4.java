...
public class MainActivity4 extends AppCompatActivity {
    ...
    public void setGrid()
    {
        ...
        map = new HashMap<>();
        map.put(2, R.drawable.i1_2);
        map.put(4, R.drawable.i1_4);
        map.put(8, R.drawable.i1_8);
        map.put(16, R.drawable.i1_16);
        map.put(32, R.drawable.i1_32);
        map.put(64, R.drawable.i1_64);
        map.put(128, R.drawable.i1_128);
        map.put(256, R.drawable.i1_256);
        map.put(512, R.drawable.i1_512);
        map.put(1024, R.drawable.i1_1024);
        map.put(2048, R.drawable.i1_2048);
    ...
    void setWinImage()
    {
        for(int i=0;i<n;i++)
        {
            for(int j=0;j<n;j++)
            {
                grid[i][j].setImageResource(R.drawable.i1_win);
                intGrid[i][j] = 0;
            }
        }
    }
