...
public class MainActivity3 extends AppCompatActivity {
    ...
    public void setGrid()
    {
        ...
        map.put(-2, R.drawable.i3_2);
        map.put(-4, R.drawable.i3_4);
        map.put(-8, R.drawable.i3_8);
        map.put(-16, R.drawable.i3_16);
        map.put(-32, R.drawable.i3_32);
        map.put(-64, R.drawable.i3_64);
    ...
    public int min()
    {
        Log.d("Visiting min function", "Visited");
        int min = 0;
        //
        int i,j;
        for(i=0;i<n;i++)
                ...
                if(this.intGrid[i][j] != 0)
                {
                    for(int c = i ; c > 0 ; c--)
                    {
                        ...
                        else if(this.intGrid[c-1][j] == this.intGrid[c][j])
                        {
                            ...
                            this.intGrid[c][j] = 0;
                            this.grid[c][j].setImageResource(R.drawable.background);
                            this.score += Math.abs(this.intGrid[c-1][j]);
                            break;
                        }
                        else
                        {
                ...
                if(this.intGrid[i][j] != 0)
                {
                    for(int c = j ; c > 0 ; c--)
                    {
                        ...
                        else if(this.intGrid[i][c-1] == this.intGrid[i][c])
                        {
                            ...
                            this.intGrid[i][c] = 0;
                            this.grid[i][c].setImageResource(R.drawable.background);
                            this.score += Math.abs(this.intGrid[i][c-1]);
                            break;
                        }
                        else
                        {
        ...
        for(int i=0;i<n;i++)
        {
            for(int j=0;j<n;j++)
            {
                ...
                grid[i][j].setImageResource(R.drawable.gameover);
                    ...
                    grid[i][j].setImageResource(R.drawable.i1_512);
                intGrid[i][j] = 0;
            }
        }
    }
        ...
        for(int i=0;i<n;i++)
        {
            for(int j=0;j<n;j++)
            {
                if(i%2==0)
                    ...
                    grid[i][j].setImageResource(R.drawable.i3_64);
                intGrid[i][j] = 0;
            }
        }
    }
